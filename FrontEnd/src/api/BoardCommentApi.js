...
export const createReply = async (parentCommentId, comment) => {
    try {
        const res = await axios.post(`${BASE_URL}/comment/reply/${parentCommentId}`, comment);
        return res.data;
    } catch (error) {
...
export const fetchRepliesByComment = async (parentCommentId) => {
    try {
        const res = await axios.get(`${BASE_URL}/comment/reply/${parentCommentId}`);
        return res.data;
    } catch (error) {
...
export const updateComment = async (commentId, content) => {
    try {
        const res = await axios.put(`${BASE_URL}/comment/${commentId}`, {content});
        return res.data;
    } catch (error) {
