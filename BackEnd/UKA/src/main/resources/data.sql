...
--찾아주세요 샘플데이터
INSERT INTO request (find, img, kind, sex, age, name, time, local, phone, detail, user_seq) VALUES
...
(false, 'http://localhost:8888/request/img/dog10.jpg', '보더-콜리', true, '4살', '초코', '2025-06-17 18:20', '서울 강동구 천호동', '010-2323-6565', '검정과 흰색 털', 1),
