...
export const fetchPostById = async (id, userId) => {
    try {
        const res = await axios.get(`${BASE_URL}/board/${id}`, {params: {userId}});
        return res.data;
    } catch (error) {
...
export const incrementViewCount = async (id) => {
    try {
        await axios.post(`${BASE_URL}/board/${id}/view`);
    } catch (error) {
...
export const toggleLikes  = async (postId, userId) => {
    try {
        const res = await axios.post(`${BASE_URL}/board/${postId}/likes`, {userId});
        return res.data;    
    } catch (error) {
...
export const toggleReport  = async (postId, userId) => {
    try {
        const res = await axios.post(`${BASE_URL}/board/${postId}/report`, {userId});    
        return res.data;
    } catch (error) {
...
export const createPost = async (newPost) => {
    try {
        const res = await axios.post(`${BASE_URL}/board`, newPost);
        return res.data;
    } catch (error) {
...
export const updatePost = async (id, updatedPost) => {
    try {
        const res = await axios.put(`${BASE_URL}/board/${id}`, updatedPost);
        return res.data;
    } catch (error) {
...
export const uploadImage = async (imageBlob) => {
    try {
        ...
        const res = await axios.post(`${BASE_URL}/board/upload-image`, formData, {
...
export const restorePost = async (id) => {
    try {
        const res = await axios.put(`${BASE_URL}/board/${id}/restore`);
        return res.data;
    } catch (error) {
